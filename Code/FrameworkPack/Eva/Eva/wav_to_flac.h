...
#ifndef Eva_wav_to_flac_h
#define Eva_wav_to_flac_h
 ...
 **/
int Eva_convertWavToFlac(const char *wave_file_in, const char *flac_file_out, int split_interval_seconds, char** out_flac_files);
