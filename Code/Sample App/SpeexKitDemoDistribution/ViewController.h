...
@interface ViewController : UIViewController <ContinuousAudioUnitDelegate, SpeexNSDataEncodingControllerDelegate, SpeexNSDataDecodingControllerDelegate,CLLocationManagerDelegate,UIBubbleTableViewDataSource,DataViewControllerDelegate,SpeechKitDelegate, SKVocalizerDelegate,AVAudioPlayerDelegate,AVAudioRecorderDelegate> {
