...
- (void)reloadData
{
    self.showsVerticalScrollIndicator = NO;////YES;//NO;
   ...
   // [self scrollToRowAtIndexPath:[NSIndexPath indexPathForRow:[self.bubbleDataSource rowsForBubbleTable:self]-1 inSection:0] atScrollPosition:UITableViewScrollPositionBottom  animated:YES];
    NSLog(@"[self.bubbleDataSource rowsForBubbleTable:self] = %d",[self.bubbleDataSource rowsForBubbleTable:self]);
    
    //[self setContentOffset:CGPointMake(CGFLOAT_MAX, CGFLOAT_MAX)]; // NEW (scroll to bottom)
