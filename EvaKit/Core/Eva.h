...
@property (nonatomic, assign) id<EvaDelegate> delegate;
...
@property(nonatomic,retain, readonly) NSString *evaAPIKey;
@property(nonatomic,retain, readonly) NSString *evaSiteCode;

@property(nonatomic) BOOL sendMicLevel;
@property(nonatomic) CGFloat micRecordTimeout;
